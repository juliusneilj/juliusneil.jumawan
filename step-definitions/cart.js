...
Then(/^The user will see the correct prices for each ordered product$/, function() {
...
Then(/^The user will see the correct subtotal of each ordered product$/, function() {
    let products = this.getProducts()
    for(let i = 0; i < products.length; i++) {
...
Then(/^The user will see the total price of all ordered products$/, function() {
